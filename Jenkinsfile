        ...
        stage('Deploy backend') {
            steps {
                 sh """
                    ...
                    kubectl rollout restart deployment/backend-deployment.yaml --kubeconfig k8s/jobs/k3s.yaml
                """
            }
        }
        ...
        stage('Deploy frontend') {
            steps {
                 sh """
                    ...
                    kubectl rollout restart deployment/frontend-deployment.yaml --kubeconfig k8s/jobs/k3s.yaml
